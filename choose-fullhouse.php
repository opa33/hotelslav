              ...
              <div class="row justify-content-center text-center mb-5">
                <div class="col-md-7">
                  <div class="card " style="border: none; border-radius: 10px;">
                    <img class="card-img-top" src="images/fullhouse.png" alt="Card image cap">
                    <div class="card-body">
                      <h3 class="card-title text-left mb-4">Full house</h3>
                      <p class="card-text text-left mb-4">Все самое лучшее для лучших.</p>
                      ...
                      <h4 class="text-left mb-4">Итого: <span class="text-primary" style="font-size: 30px;"><?php echo number_format($totalPricefullhouse, 0, ',', ' '); ?> ₽ / <?php echo $nightCount; ?> nights</span></h4>
